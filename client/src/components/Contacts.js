...
const MapComponent = compose(
    withProps({
        ...
        containerElement: <div style={{ height: `540px`, margin: "0 30px"}} />,
        ...
        return (
            <div>
                <div className="text-secondary text-xl-center" style={{margin: "80px 0 70px", letterSpacing: ".5px"}}>
                    <p className="lead">
                        <span className="fa fa-map-marker"  style={{marginRight: "7px"}}></span>
                        <span className="font-weight-bold">Address:</span> Viskozna str., Kyiv, UKRAINE
                    </p>
                    <p className="lead">
                        <span className="fa fa-mobile-phone"  style={{marginRight: "7px"}}></span>
                        <span className="font-weight-bold">Phone:</span> +38 (099) 999-99-99
                    </p>
                    <p className="lead">
                        <span className="fa fa-envelope-o" style={{marginRight: "7px"}}></span>
